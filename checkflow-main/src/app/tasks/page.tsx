...
export default function TasksPage() {
  ...
  // File upload handler — txt only, zero dependencies
    ...
    try {
      if (ext === 'txt') {
        ...
        if (steps.length) {
          ...
          setUploadError('No steps found. Make sure each line has content.')
        }
      } else if (ext === 'docx' || ext === 'pdf') {
        setUploadError('For DOCX/PDF: open the file, copy the text, and paste it into the text box below.')
      } else {
        setUploadError('Upload a .txt file, or paste your SOP text in the box below.')
      }
    } catch (err: any) {
