...
export default function DashboardPage() {
  ...
  useEffect(() => {
    ...
    Promise.all([
      ...
      const myId = JSON.parse(localStorage.getItem('cf_user')||'{}')?.employee_id
      const isOwnerRole = JSON.parse(localStorage.getItem('cf_user')||'{}')?.role === 'owner'
      const allTasks = ta||[]
    ...
    // Realtime — re-fetch KPIs when any session is updated (e.g. payment edited in Cashflow)
