          ...
          return (
            <div key={e.id} className="card" style={{ padding:18 }}>
              ...
              <button onClick={() => toggleAvail(e.id, avail)}
                style={{ width:'100%',padding:'7px',borderRadius:8,fontSize:12,fontWeight:600,cursor:'pointer',marginBottom:8,border:'1px solid',
                  background: avail?'rgba(16,185,129,.12)':'rgba(75,85,99,.2)',
                  color: avail?'#34D399':'#6B7280',
                  borderColor: avail?'rgba(16,185,129,.3)':'rgba(75,85,99,.3)' }}>
