...
import {
  LayoutDashboard, CalendarDays, SquareCheckBig, Users,
...
export default function AppShell({ children }: { children: React.ReactNode }) {
  ...
  if (loading || !user) return (
    <div style={{minHeight:'100dvh',background:'#080B14',display:'flex',alignItems:'center',justifyContent:'center'}}>
      <div style={{width:44,height:44,background:'linear-gradient(135deg,#6D28D9,#8B5CF6)',borderRadius:10,display:'flex',alignItems:'center',justifyContent:'center',fontWeight:700,fontSize:18,color:'#EAB308'}}>P</div>
    </div>
  )
  ...
  const sidebar = (
    <div style={{ display:'flex', flexDirection:'column', height:'100%', position:'relative' }}>
      {/* Logo */}
      <div style={{ display:'flex', alignItems:'center', gap:10, padding:'14px 12px', borderBottom:'1px solid #2D1F4E', minHeight:70 }}>
        <div style={{ width:44,height:44,background:'linear-gradient(135deg,#6D28D9,#8B5CF6)',borderRadius:10,display:'flex',alignItems:'center',justifyContent:'center',fontWeight:700,fontSize:18,color:'#EAB308',flexShrink:0 }}>P</div>
        {!collapsed && (
      ...
      <div style={{ borderTop:'1px solid #2D1F4E', padding:8, display:'flex', flexDirection:'column', gap:2 }}>
        <Link href="/settings" className="nav-link" style={{ color:'#4B5563', justifyContent:collapsed?'center':'flex-start' }}>
  ...
  return (
    <div style={{ background:'#080B14', color:'#E8ECF4', minHeight:'100dvh' }}>
        ...
        <div style={{ flex:1, display:'flex', flexDirection:'column', minWidth:0 }}>
          <header style={{ display:'flex', alignItems:'center', justifyContent:'space-between', padding:'0 24px', height:60, background:'#0C0F1E', borderBottom:'1px solid #2D1F4E', flexShrink:0 }}>
            ...
            <div style={{ display:'flex', alignItems:'center', gap:10 }}>
              ...
              <div style={{ width:30,height:30,borderRadius:'50%',background:'linear-gradient(135deg,#6D28D9,#8B5CF6)',display:'flex',alignItems:'center',justifyContent:'center',fontSize:11,fontWeight:700,color:'#EAB308' }}>
      ...
      <div className="flex flex-col md:hidden" style={{ minHeight:'100dvh' }}>
        ...
        <nav style={{ position:'fixed', bottom:0, left:0, right:0, zIndex:40, display:'flex', background:'#0C0F1E', borderTop:'1px solid #2D1F4E', paddingBottom:'env(safe-area-inset-bottom)' }}>
