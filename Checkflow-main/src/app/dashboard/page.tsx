...
export default function DashboardPage() {
  ...
  useEffect(() => {
    ...
    Promise.all([
      ...
      supabase.from('tasks').select('id,client_name,task_type,stage').order('created_at','asc' as any).limit(10),
  ...
  return (
    <div className="page-pad">
      <div style={{ display:'flex',alignItems:'flex-start',justifyContent:'space-between',marginBottom:22,flexWrap:'wrap',gap:10 }}>
        <div>
          <div className="page-badge" style={{ background:'rgba(139,92,246,.15)',color:'#A78BFA',border:'1px solid rgba(139,92,246,.3)' }}>OWNER DASHBOARD</div>
      ...
      <div className="g4" style={{ marginBottom:16 }}>
        {[
          ...
          { label:'Pipeline', value:String(tasks.length), sub:'tasks', Icon:SquareCheckBig, c:'#22D3EE', bg:'rgba(6,182,212,.12)', b:'rgba(6,182,212,.2)' },
      ...
      <div className="g4">
        {[
          ...
          ...(user?.role==='owner'?[{ href:'/cashflow',label:'Cashflow',c:'#10B981',bg:'rgba(16,185,129,.1)',b:'rgba(16,185,129,.2)' }]:[]),
