...
export default function AppShell({ children }: { children: React.ReactNode }) {
  ...
  if (loading || !user) return (
    <div style={{ minHeight:'100dvh', background:'#080B14', display:'flex', alignItems:'center', justifyContent:'center' }}>
      <div style={{ width:48, height:48, borderRadius:12, overflow:'hidden', background:'#fff' }}>
  ...
  const Logo = ({ size = 44 }: { size?: number }) => (
    <div style={{ width:size, height:size, borderRadius:10, overflow:'hidden', flexShrink:0, background:'#fff', display:'flex', alignItems:'center', justifyContent:'center' }}>
      <img src="/logo.jpg" alt="The Pentagon" style={{ width:'100%', height:'100%', objectFit:'cover' }}/>
    </div>
  )
        ...
        <div style={{ flex:1, display:'flex', flexDirection:'column', minWidth:0 }}>
          <header style={{ display:'flex', alignItems:'center', justifyContent:'space-between', padding:'0 24px', height:60, background:'#0C0F1E', borderBottom:'1px solid #2D1F4E', flexShrink:0 }}>
            ...
            <div style={{ display:'flex', alignItems:'center', gap:10 }}>
              ...
              <div style={{ width:30, height:30, borderRadius:'50%', overflow:'hidden', background:'#fff' }}>
